...
class FI_orgao_fomentoCreate(LoginRequiredMixin, CreateView):
...
class FI_orgao_fomentoListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        objects = FI_orgao_fomento.objects.all().order_by('nome')
        filter = FI_orgao_fomentoFilter(self.request.GET, queryset=objects)
        ...
        context['fi_orgao_fomento_filter'] = filter
        context['page_obj'] = page_obj
        return context

class FI_orgao_fomentoUpdateView(LoginRequiredMixin, UpdateView):
    model = FI_orgao_fomento
    template_name = 'Acesso_Restrito/fi_orgao_fomento_update.html'
    fields = '__all__'

    def get_success_url(self):
        return reverse('fi_orgao_fomento-list')

class FI_orgao_fomentoDeleteView(LoginRequiredMixin, DeleteView):
    model = FI_orgao_fomento
    template_name = 'Acesso_Restrito/fi_orgao_fomento_delete.html'
