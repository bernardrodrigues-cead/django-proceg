    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duracao_esperada', models.PositiveIntegerField(blank=True, help_text='(meses)', null=True, validators=[procead.validators.validate_is_zero_or_positive], verbose_name='Duração esperada')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_inicio', models.TimeField(help_text='hh:mm', verbose_name='Hora de início')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('num_vagas', models.PositiveIntegerField(validators=[procead.validators.validate_is_zero_or_positive], verbose_name='Número de vagas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodos', models.PositiveIntegerField(validators=[procead.validators.validate_is_zero_or_positive], verbose_name='Quantidade de Períodos')),
